...
def get_data(folder=os.path.join(os.getcwd(), 'downloaded_data'),
             link='https://github.com/JGCRI/pytemplate/raw/dev/examples.zip'):
    ...
    # If folder is empty then skip download
    if len(os.listdir(folder))==0:
        ...
        logging.warning(f'{folder} is not empty so download has been skipped. '
                     ...
                     f'save to a different directory.')
